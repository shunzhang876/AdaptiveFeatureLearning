...
void TripletContrastiveLossLayer<Dtype>::LayerSetUp(  
...
template <typename Dtype>  
void TripletContrastiveLossLayer<Dtype>::Forward_cpu(  
...
template <typename Dtype>  
void TripletContrastiveLossLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,  
